...
## Таблиця 2. Вартість експлуатації транспорту (грн/км)
|               | Автобус | Трамвай | Тролейбус |
|---------------|--------:|--------:|----------:|
| Volvo         | 20      | 7       | 13        |
| Skoda         | 25      | 8       | 12        |
...
## Реалізація
У проєкті використано шаблон проектування «Абстрактна фабрика».

- `MunicipalTransportFactory` — абстрактна фабрика для створення сімейства транспорту одного виробника.
- `VolvoFactory`, `SkodaFactory`, `HyundaiFactory` — конкретні фабрики.
- `Bus`, `Tram`, `Trolleybus` — продукти.
- `ContractCalculator` — обчислює загальну вартість контракту для вибраного виробника.
- `Main` — точка входу в програму.

## Очікуваний результат для вхідних даних з умови
- Volvo: 541000000 грн
- Skoda: 516000000 грн
- Hyundai: 516500000 грн

Отже, найвигідніший контракт — **Skoda**.
